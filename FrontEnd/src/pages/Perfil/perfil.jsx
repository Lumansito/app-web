...
export function Perfil() {
  const { datosUsuario, dni, obtenerDatosPersonales, rol, cerrarSesion, comprobarToken } = useUsuario();
              ...
              <>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <h2 className="text-xl font-semibold text-gray-800">{datosUsuario.membresia}</h2>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <h2 className="text-xl font-semibold text-gray-800">{datosUsuario.fechaPago}</h2>
                  </div>
                </div>
              </>
            )}
